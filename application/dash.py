...
app.layout = html.Div([
  ...
  html.Br(),
    dbc.Row(
        ...
        html.P('En este dashboard se presentan análisis de los distintos impactos que en redes sociales tiene la Subsecretaría, específicamente en Twitter, Facebook e Instagram, en el intervalo que comprenden del mes de enero a junio 2021.',
